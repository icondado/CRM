            ...
            <tbody>
                @forelse ($documentos as $documento)
                    <tr>
                        ...
                        <td>{{ $documento->carpeta->nombre_original ?? $documento->id_carpeta }}</td>
                            ...
                            @if ($documento->file && $documento->file !== 'sin_archivo')
                                ...
                                @if (in_array($ext, ['jpg', 'jpeg', 'png']))
                                    ...
                                    <a href="{{ asset('storage/carpetas/' . $documento->file) }}" download
                                        class="mt-1 btn btn-sm btn-outline-secondary">
                                ...
                                @elseif ($ext === 'pdf')
                                    ...
                                    <a href="{{ asset('storage/carpetas/' . $documento->file) }}" download
                                        class="mt-1 btn btn-sm btn-outline-secondary">Descargar</a>
                        ...
                        <td class="text-center">
                            <div class="gap-2 d-flex justify-content-center">
                                ...
                                <form action="{{ route('crm.admin.documentos.destroy', $documento->id_documento) }}"
...
@include('crm.admin.documentos.nuevo')
@include('crm.admin.documentos.edit')